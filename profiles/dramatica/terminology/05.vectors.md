...
This public Dramatica-profile reference documents the published values associated with each Dynamic. It does not determine which combination is semantically valid for a Storyform.
