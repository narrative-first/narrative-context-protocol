...
The normative candidate Core JSON Schema is [`../../core/ncp-core-schema.json`](../../core/ncp-core-schema.json). Profile and extension schemas are versioned separately. A future serialization may represent the same protocol model without changing Core semantics or the meaning of a declared profile.
