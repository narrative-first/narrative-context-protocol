...
The binding transports declared profile data without redefining its semantics. Applications needing Dramatica creation, resolution, diagnosis, completion, semantic validation, or certification use licensed Dramatica capabilities through [Dramatica.com](https://dramatica.com/) or **support@dramatica.com**.
